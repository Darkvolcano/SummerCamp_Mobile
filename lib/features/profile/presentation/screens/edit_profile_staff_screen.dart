...
class EditProfileStaffScreen extends StatefulWidget {
  final User user;
  const EditProfileStaffScreen({super.key, required this.user});

  @override
  State<EditProfileStaffScreen> createState() => _EditProfileStaffScreenState();
}

class _EditProfileStaffScreenState extends State<EditProfileStaffScreen> {
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        actions: [
          TextButton(
            child: const Text(
              'Đóng',
              style: TextStyle(color: StaffTheme.staffAccent),
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(color: StaffTheme.staffPrimary),
      ),
      body: Form(
        key: _formKey,
        child: ListView(
            ...
            Center(
              child: Stack(
                ...
                children: [
                  CircleAvatar(
                    radius: 60,
                    backgroundColor: StaffTheme.staffPrimary.withValues(
                      alpha: 0.1,
                    ),
  ...
  InputDecoration _inputDecoration(String label, IconData icon) {
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: StaffTheme.staffAccent, width: 2),
      ),
    );
  }
}
