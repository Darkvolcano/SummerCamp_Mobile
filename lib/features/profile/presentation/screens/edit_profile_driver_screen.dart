...
class EditProfileDriverScreen extends StatefulWidget {
  final User user;
  const EditProfileDriverScreen({super.key, required this.user});

  @override
  State<EditProfileDriverScreen> createState() =>
      _EditProfileDriverScreenState();
}

class _EditProfileDriverScreenState extends State<EditProfileDriverScreen> {
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        actions: [
          TextButton(
            child: const Text(
              'Đóng',
              style: TextStyle(color: DriverTheme.driverAccent),
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(color: DriverTheme.driverPrimary),
      ),
      body: Form(
        key: _formKey,
        child: ListView(
            ...
            Center(
              child: Stack(
                ...
                children: [
                  CircleAvatar(
                    radius: 60,
                    backgroundColor: DriverTheme.driverPrimary.withValues(
                      alpha: 0.1,
                    ),
  ...
  InputDecoration _inputDecoration(String label, IconData icon) {
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: DriverTheme.driverAccent, width: 2),
      ),
    );
  }
}
